...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-primary/5 via-background to-muted/20" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          >
            <div>
              <h3 className="text-xl font-bold bg-linear-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">
                Hamid Sadim
              </h3>
